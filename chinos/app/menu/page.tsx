  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        ...
        // Derive unique categories dynamically from backend response
        const unique = ["All", ...Array.from(new Set(data.map((item) => item.category)))];
                ...
                >
                  ...
                  <div className="p-5 flex flex-col gap-2">
                    <div className="flex items-start justify-between gap-2">
                      <h3 className="font-[Playfair_Display] font-bold text-lg text-[var(--color-red-deep)] leading-tight">
                        {item.name}
                      </h3>
                    ...
                    <div className="flex items-center justify-between mt-1">
                      <span className="font-[var(--font-montserrat)] text-[0.65rem] tracking-[0.2em] uppercase text-[var(--color-red)] opacity-50">
                        {item.category}
                      </span>
                      <span className={`font-[var(--font-montserrat)] text-[0.65rem] tracking-[0.1em] uppercase ${
                        item.isAvailable
                          ? "text-[var(--color-red)]"
                          : "text-[var(--color-red-deep)] opacity-40"
                      }`}>
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col justify-center gap-4 p-8">
              ...
              <h2 className="font-[Playfair_Display] text-3xl font-bold text-[var(--color-red-deep)]">
                {selectedItem.name}
              </h2>
              ...
              {!selectedItem.isAvailable && (
                <p className="font-[var(--font-montserrat)] text-[0.75rem] tracking-[0.1em] uppercase text-[var(--color-red-deep)] opacity-40">
