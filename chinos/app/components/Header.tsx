    ...
    <>
      ...
      >
        <div className="max-w-[1400px] mx-auto h-20 flex items-center justify-between gap-8">
          ...
          >
            <span className={`block w-6 h-[1.5px] bg-[var(--color-cream)] transition-all duration-300 origin-center ${menuOpen ? "translate-y-[6.5px] rotate-45" : ""}`} />
            <span className={`block w-6 h-[1.5px] bg-[var(--color-cream)] transition-all duration-300 ${menuOpen ? "opacity-0" : "opacity-100"}`} />
            <span className={`block w-6 h-[1.5px] bg-[var(--color-cream)] transition-all duration-300 origin-center ${menuOpen ? "-translate-y-[6.5px] -rotate-45" : ""}`} />
          </button>
